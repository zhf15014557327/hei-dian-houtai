    ...
    <el-row>
      <el-col :span="24">
        <div class="grid-content bg-purple-dark">
          <mianbaoxu title1="商品管理" title2="商品列表"></mianbaoxu>
        </div>
      </el-col>
    </el-row>
    ...
    class="mr"
      ...
      <el-tabs
        ...
        <el-tab-pane label="商品内容" name="4">
          ...
          <vue-editor v-model="addForm.goods_introduce" class="editor"></vue-editor>
        </el-tab-pane>
      </el-tabs>
    </el-form>
  </div>
  ...
  methods: {
    ...
    async addGoods() {
      this.$refs.addFormRef.validate(async (valid) => {
        ...
        const res = await this.$axios.post('/goods', o);
    ...
    async handleTabClick() {
      ...
      if (this.activeTabName === '1' || this.activeTabName === '2') {
        ...
        const res = await this.$axios.get(`/categories/${this.addForm.goods_cat[2]}/attributes`, {
          params: {
